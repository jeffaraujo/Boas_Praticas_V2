...
namespace APP.AulaAtributo
{
    public class AlunoRepository
    {
        ...
        //[Obsolete("O método será removido na versão .NET Core 3", true)]
        public void GetDisplayAluno()
        {
            GetAluno();
            GetCursoPorAluno();
            GetDebbugInformation();
            GetFiapInformation();
        }

        [Conditional("DEBUG")]
        private void GetDebbugInformation()
        {
        ...
        {
            if (original) _corOriginal = ForegroundColor;
            else ForegroundColor = _corOriginal;
        }
